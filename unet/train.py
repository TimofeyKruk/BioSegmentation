...
def train_net(net,
    ...
    val_loader = DataLoader(val, batch_size=batch_size, shuffle=False, num_workers=2, pin_memory=False, drop_last=True)
    ...
    scheduler = optim.lr_scheduler.CyclicLR(optimizer, base_lr=lr, max_lr=2e-6)
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for imgs, true_masks in train_loader:
                ...
                if global_step % (n_train // (5 * batch_size)) == 0:
                    ...
                    # TODO: return this if original scheduler is back
                ...
                # TODO: delete this if original scheduler is back
                scheduler.step()
